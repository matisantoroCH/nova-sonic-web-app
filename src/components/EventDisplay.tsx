...
class S2sEventDisplay extends React.Component<EventDisplayProps, EventDisplayState> {
    private message: any;
    ...
    componentDidUpdate(prevProps: EventDisplayProps, prevState: EventDisplayState) {
    ...
    displayEvent(event: any, type?: string) {
        ...
        return (
            <div>
                ...
                <div className='events'>
                    {this.state.eventsByContentName.map((event: any, index: number) => {
                        if (!this.state.displayUsage && event.name === "usageEvent")
                            ...
                            <div key={index} className={
                                ...
                                <div className="tooltip">
                                    <pre id="jsonDisplay">{event.events.map((e: any, i: number) => {
